...
class Global {
    ...
    static var setMostPopularArticleVisible = true
    ...
    static var countLoadCommentsInPagination = 10
    static var countLoadMostPopularArticle = 6
    ...
    static var baseVC: UIViewController? = nil
