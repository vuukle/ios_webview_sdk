...
@protocol VUTalkOfTheTownDelegate;
@class UIScrollView;
@class UIView;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) id <VUTalkOfTheTownDelegate> _Nullable delegate;)
+ (id <VUTalkOfTheTownDelegate> _Nullable)delegate SWIFT_WARN_UNUSED_RESULT;
+ (void)setDelegate:(id <VUTalkOfTheTownDelegate> _Nullable)value;
...
+ (BOOL)isVuukleAdsHiden SWIFT_WARN_UNUSED_RESULT;
...
+ (BOOL)isEmojiVotingHiden SWIFT_WARN_UNUSED_RESULT;
...
+ (NSInteger)commentPagination SWIFT_WARN_UNUSED_RESULT;
...
+ (BOOL)isTalkOfTheTownHiden SWIFT_WARN_UNUSED_RESULT;
...
+ (NSInteger)talkOfTheTownCount SWIFT_WARN_UNUSED_RESULT;
...
+ (NSInteger)talkOfTheTownHours SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP6Vuukle23VUTalkOfTheTownDelegate_")
@protocol VUTalkOfTheTownDelegate
@optional
- (void)openArticleWithTitle:(NSString * _Nonnull)title apiKey:(NSString * _Nonnull)apiKey articleHost:(NSString * _Nonnull)articleHost articleID:(NSString * _Nonnull)articleID articleURL:(NSString * _Nonnull)articleURL;
@end
