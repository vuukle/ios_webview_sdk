//
//  VUNetworkReachabilityManager.swift
//  pod 'Vuukle'
//
...
//
  ...
  open class VUInternetReachability {
    ...
    */
    ...
    // - returns: The new 'VUNetworkReachabilityManager' instance.
    ...
    open func startListening() -> Bool {
      ...
      let callbackEnabled = SCNetworkReachabilitySetCallback( reachability,
        { (_, flags, info) in
          ...
          let reachability = Unmanaged<VUInternetReachability>.fromOpaque(info!).takeUnretainedValue()
  ...
  extension VUInternetReachability.NetworkReachabilityStatus: Equatable {}
  ...
  public func == ( lhs: VUInternetReachability.NetworkReachabilityStatus,
                   rhs: VUInternetReachability.NetworkReachabilityStatus) -> Bool {
